...
$(document).ready(function() {
	...
	*/
	...
	function printResult() {
		...
		//alert(win[b.pos]);
		//alert(win[c.pos]);
		console.log("log: " + win[a.pos] + ", " + win[b.pos] + ", " + win[c.pos] + "; ");
		console.log("log: " + win[d.pos] + ", " + win[e.pos] + ", " + win[f.pos] + "; ");
		console.log("log: " + win[g.pos] + ", " + win[h.pos] + ", " + win[i.pos] + "; ");
		
		if(win[a.pos] === win[b.pos] && win[b.pos] === win[c.pos] || 
		   win[d.pos] === win[e.pos] && win[e.pos] === win[f.pos] ||
		   win[g.pos] === win[h.pos] && win[h.pos] === win[i.pos] ||
		   win[a.pos] === win[d.pos] && win[d.pos] === win[g.pos] ||
		   win[b.pos] === win[e.pos] && win[e.pos] === win[h.pos] ||
		   win[c.pos] === win[f.pos] && win[f.pos] === win[i.pos] ||
		   win[a.pos] === win[e.pos] && win[e.pos] === win[i.pos] ||
		   win[c.pos] === win[e.pos] && win[e.pos] === win[g.pos]
		   ) 
		{
			res = "You Win!";
		} else {
	...
	var a = new Slot('#slot1', 30, 1),
		...
		e = new Slot('#slot5', 80, 5),
		f = new Slot('#slot6', 60, 6),
		g = new Slot('#slot7', 40, 7),
		h = new Slot('#slot8', 70, 8),
		i = new Slot('#slot9', 80, 9);
		...
		if(this.innerHTML == "Start") {
            ...
            x = window.setInterval(function() {
                if(a.speed === 0 && b.speed === 0 && c.speed === 0 && 
                   d.speed === 0 && e.speed === 0 && f.speed === 0 && 
                   g.speed === 0 && h.speed === 0 && i.speed === 0 && completed === 9) {
                    enableControl();
                    window.clearInterval(x);
					printResult();
                }
